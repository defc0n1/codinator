...
class FileMoverViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        do {
            inspectorUrl = fileUrl!.deletingLastPathComponent()
    ...
    @IBAction func moveFile() {
        ...
        let destinationUrl = inspectorUrl?.appendingPathComponent(fileUrl!.lastPathComponent)
    ...
    @IBAction func backDidPush(_ sender: UIBarButtonItem) {
        inspectorUrl = inspectorUrl?.deletingLastPathComponent()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let url = inspectorUrl?.appendingPathComponent(text) {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let selectedUrl = inspectorUrl?.appendingPathComponent(items![(indexPath as NSIndexPath).row].lastPathComponent, isDirectory: true)
